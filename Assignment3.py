...
plt.legend(*p1.legend_elements(), title='Clusters', prop={'size': 15},bbox_to_anchor=(1, 1.04))
plt.subplot(2, 2, 2)
plt.title("Plot 2")
...
plt.subplot(2, 2, 1)
plt.title("Plot 1")
p1 = plt.scatter(independent_var["Age"], independent_var["Flight_Distance"],c=k_means_output,cmap="viridis", s = 40,label = 'Cluster 1')
plt.scatter(outliers["Age"], outliers["Flight_Distance"], c='aqua', s=100)
plt.xlabel('Age', fontsize=10)
plt.ylabel('Flight_Distance', fontsize=10)
plt.legend(*p1.legend_elements(), title='Clusters', prop={'size': 6})
plt.subplot(2, 2, 2)
plt.title("Plot 2")
plt.scatter(independent_var["Age"], independent_var["Arrival_Delay"],c=k_means_output,cmap="viridis", s = 40, label = 'Cluster 2')
plt.scatter(outliers["Age"], outliers["Arrival_Delay"], c='aqua', s=100)
plt.xlabel('Age', fontsize=10)
plt.ylabel('Arrival_Delay', fontsize=10)
plt.subplot(2, 2, 3)
plt.title("Plot 3")
plt.scatter(independent_var["Flight_Distance"], independent_var["Arrival_Delay"],c=k_means_output,cmap="viridis", s = 40, label = 'Cluster 3')
...
plt.subplot(2, 2, 1)
plt.title("Plot 1")
p1 = plt.scatter(independent_var["Age"], independent_var["Flight_Distance"],c=GmmClusters,cmap="viridis", s = 40, label = 'Cluster 1')
plt.xlabel('Age', fontsize=10)
plt.ylabel('Flight_Distance', fontsize=10)
plt.legend(*p1.legend_elements(), title='Clusters', prop={'size': 15},bbox_to_anchor=(1, 1.04))
plt.subplot(2, 2, 2)
plt.title("Plot 2")
plt.scatter(independent_var["Age"], independent_var["Arrival_Delay"],c=GmmClusters,cmap="viridis", s = 40, label = 'Cluster 2')
plt.xlabel('Age', fontsize=10)
plt.ylabel('Arrival_Delay', fontsize=10)
plt.subplot(2, 2, 3)
plt.title("Plot 3")
plt.scatter(independent_var["Flight_Distance"], independent_var["Arrival_Delay"],c=GmmClusters,cmap="viridis", s = 40, label = 'Cluster 3')
plt.subplots_adjust(hspace=0.6, wspace=0.6)
plt.xlabel('Flight_Distance', fontsize=10)
plt.ylabel('Arrival_Delay', fontsize=10)
plt.show()
...
plt.scatter(independent_var["Age"], independent_var["Flight_Distance"], c=df['anomaly_gmm_pct'], cmap='rainbow')
plt.xlabel('Age', fontsize=10)
plt.ylabel('Flight_Distance', fontsize=10)
plt.title("Plot 1")
plt.subplot(2, 2, 2)
plt.title("Plot 2")
plt.scatter(independent_var["Age"], independent_var["Arrival_Delay"],c=df['anomaly_gmm_pct'],cmap="rainbow", s = 40,label = 'Cluster 1')
plt.xlabel('Age', fontsize=10)
plt.ylabel('Arrival_Delay', fontsize=10)
plt.subplot(2, 2, 3)
plt.title("Plot 3")
plt.scatter(independent_var["Flight_Distance"], independent_var["Arrival_Delay"],c=df['anomaly_gmm_pct'],cmap="rainbow", s = 40,label = 'Cluster 2')
plt.subplots_adjust(hspace=0.6, wspace=0.6)
plt.xlabel('Flight_Distance', fontsize=10)
plt.ylabel('Arrival_Delay', fontsize=10)
plt.show()